    ...
    constructor(endTime) {
      ...
      draw() {
        ...
        text("Twój czas: " + 
          nf(minutes, 2) + ":" + 
          nf(seconds, 2) + "," + 
          nf(milliseconds, 3), width / 2, height / 2 + 20); //tekst z czasem końcowym
    
        textSize(16);
        text("Naciśnij przycisk, by spróbować ponownie.", width / 2, height * 2/3); //informacja o restarcie gry
      }
    }
